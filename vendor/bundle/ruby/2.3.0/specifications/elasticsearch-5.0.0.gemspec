# -*- encoding: utf-8 -*-
# stub: elasticsearch 5.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<elasticsearch-transport>, ["= 5.0.0"])
      s.add_runtime_dependency(%q<elasticsearch-api>, ["= 5.0.0"])
      ...
      s.add_dependency(%q<elasticsearch-transport>, ["= 5.0.0"])
      s.add_dependency(%q<elasticsearch-api>, ["= 5.0.0"])
