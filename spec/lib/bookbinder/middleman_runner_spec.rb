...
module Bookbinder
  describe MiddlemanRunner do
    ...
    let(:verbose) { false }
    let(:sections) { [
        Section.new(logger, GitHubRepository.new(full_name: '', directory: 'my/place/rocks'), 'my_subnav_template', 'my/place/rocks'),
        Section.new(logger, GitHubRepository.new(full_name: '', directory: 'fraggles/rock'), nil, 'fraggles/rock'),
    ] }
